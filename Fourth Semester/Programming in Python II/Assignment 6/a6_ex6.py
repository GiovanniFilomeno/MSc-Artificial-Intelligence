...
from a6_ex1 import preprocess_data          # exercise 1
from a6_ex3 import get_data_loaders         # exercise 3
from a6_ex4 import PM_Model                 # exercise 4

# ---------------------------------------------------------------------
# 0) Utilities: seed and device
# ---------------------------------------------------------------------
...
# Regenerate the data if the CSV does not exist.
...
# ---------------------------------------------------------------------
# 2) Search space: at least four configurations
# ---------------------------------------------------------------------
CONFIGS: List[Dict] = [
...
def train_one(cfg: Dict) -> Tuple[float, float, float]:
    """
    Train one model with config `cfg` and return
...
# ---------------------------------------------------------------------
# 4) Loop over all configurations and save results
# ---------------------------------------------------------------------
lines = [ 
...
for i, cfg in enumerate(CONFIGS, 1):
    ...
    print(lines[-1])   # Live console output
