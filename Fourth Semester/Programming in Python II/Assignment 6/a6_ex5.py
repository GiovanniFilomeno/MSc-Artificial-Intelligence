...
# -----------------------------------------------------------------------------
# train_model: function required by the exercise
# -----------------------------------------------------------------------------
def train_model(
    model: nn.Module,
    ...
    """
    Train the model to predict PM2.5, print losses, save weights,
    and save a comparison plot for the test set.

    Saved artifacts:
    ----------
    - model.pt: model weights (state_dict)
    - model_prediction.pdf: Predicted vs Actual line plot on the test set
    """
    # --------------------------------------------------
    # Hyperparameters
    # --------------------------------------------------
    ...
    for epoch in range(epochs + 1):
        ...
        # Print every 50 epochs, including epoch 0, as requested.
...
# -----------------------------------------------------------------------------
# Quick optional test: mini-batch training on synthetic data
# -----------------------------------------------------------------------------
if __name__ == "__main__":
    # run_training.py, or replace the main block in a6_ex5.py.
